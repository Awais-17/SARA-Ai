...
ERROR_ANALYST_PROMPT = """You are the error recovery module of S.A.R.A. AI assistant.
...
def analyze_error(
    ...
    # using _GenaiWrapper compatible with google-genai
    model = _GenaiWrapper(
...
def generate_fix(step: dict, error: str, fix_suggestion: str) -> dict:
    ...
    """
    model = _GenaiWrapper(model_name="gemini-2.0-flash")
