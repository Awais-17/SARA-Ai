...
_APP_ALIASES: dict[str, dict[str, str]] = {
    ...
    "gmail":              {"Windows": "chrome",                  "Darwin": "Google Chrome",        "Linux": "google-chrome"},
    "google maps":        {"Windows": "chrome",                  "Darwin": "Google Chrome",        "Linux": "google-chrome"},
    "maps":               {"Windows": "chrome",                  "Darwin": "Google Chrome",        "Linux": "google-chrome"},
    "vscode":             {"Windows": "code",                    "Darwin": "Visual Studio Code",   "Linux": "code"},
    "visual studio code": {"Windows": "code",                    "Darwin": "Visual Studio Code",   "Linux": "code"},
    "code":               {"Windows": "code",                    "Darwin": "Visual Studio Code",   "Linux": "code"},
    "cursor":             {"Windows": "cursor",                  "Darwin": "Cursor",               "Linux": "cursor"},
    "android studio":     {"Windows": "studio64",                "Darwin": "Android Studio",       "Linux": "studio.sh"},
    "rider":              {"Windows": "rider64",                 "Darwin": "Rider",                "Linux": "rider"},
    "pycharm":            {"Windows": "pycharm64",               "Darwin": "PyCharm",              "Linux": "pycharm"},
    "webstorm":           {"Windows": "webstorm64",              "Darwin": "WebStorm",             "Linux": "webstorm"},
    ...
    "camera":             {"Windows": "Microsoft.WindowsCamera", "Darwin": "Photo Booth",          "Linux": "cheese"},
    "clock":              {"Windows": "ms-clock:",               "Darwin": "Clock",                "Linux": "gnome-clocks"},
    "calendar":           {"Windows": "outlookcal:",             "Darwin": "Calendar",             "Linux": "gnome-calendar"},
...
def _is_running_windows(app_name: str) -> bool:
    """Return True if a process matching app_name is already running."""
    if not _PSUTIL:
        return False
    exe_lower = app_name.lower().replace(".exe", "")
    for proc in _psutil_processes():
        try:
...
def _launch_windows(app_name: str) -> bool:
    ...
    # 1. If already running → just focus
    if _is_running_windows(app_name):
        print(f"[open_app] '{app_name}' already running — focusing.")
        _focus_windows(app_name)
        return True

    # 2. Direct shell launch (fastest)
    ...
    # 3. URI / protocol handler (ms-settings:, outlookcal:, etc.)
    if ":" in app_name:
        try:
